...
export interface SanitizeOptions {
  ...
  /** When false (default), tracking query params are stripped from link hrefs. Safe-HTML always does this; Full-HTML leaves links untouched to show the email "as-is". */
